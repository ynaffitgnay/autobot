...
const Point2D landmarkLocation[] = {
  ...
  Point2D(-FIELD_X / 6.0, -HALF_FIELD_Y),    //  WO_BEACON_BLUE_YELLOW
  Point2D(-FIELD_X / 6.0, -HALF_FIELD_Y),    //  WO_BEACON_YELLOW_BLUE,
  Point2D(0, HALF_FIELD_Y),                  //  WO_BEACON_BLUE_PINK
  Point2D(0, HALF_FIELD_Y),                  //  WO_BEACON_PINK_BLUE
  Point2D(FIELD_X / 6.0, -HALF_FIELD_Y),     //  WO_BEACON_PINK_YELLOW
  Point2D(FIELD_X / 6.0, -HALF_FIELD_Y),     //  WO_BEACON_YELLOW_PINK,
