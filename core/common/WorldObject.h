...
ENUM(WorldObjectType,   // Types of objects  // 0
  ...
  WO_OBSTACLE_UNKNOWN_5,  // 34
  WO_OBSTACLE_UNKNOWN_6,  // 35
  WO_OBSTACLE_UNKNOWN_7,  // 36
  WO_OBSTACLE_UNKNOWN_8,  // 37
  WO_OBSTACLE_UNKNOWN_9,  // 38
  WO_OBSTACLE_UNKNOWN_10, // 39
  WO_OBSTACLE_UNKNOWN_11, // 40
  WO_OBSTACLE_UNKNOWN_12, // 41
  WO_OBSTACLE_UNKNOWN_13, // 42
  WO_OBSTACLE_UNKNOWN_14, // 43
  WO_OBSTACLE_UNKNOWN_15, // 44
...
const int NUM_UNKNOWN_OBSTACLES = 15;
const int UNKNOWN_OBSTACLE_OFFSET = WO_OBSTACLE_UNKNOWN_1;
...
DECLARE_INTERNAL_SCHEMA(class WorldObject {
  public:
    ...
    WO_PROPERTY(isUnknownObstacle) {
      return (type >= WO_OBSTACLE_UNKNOWN_1 && type <= WO_OBSTACLE_UNKNOWN_15);
    }
